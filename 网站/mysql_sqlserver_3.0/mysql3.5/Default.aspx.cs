...
namespace mysql3._5
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            String Mysqlcmd = "create table " + tablename + " (number int primary key, name varchar(30) not null, age varchar(30) not null, sex varchar(30) not null, class varchar(30) not null)";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Mysqlcmd = "insert into " + tablename + " values(" + key + ", 'a', 'b', 'c', 'd')";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            Mysqlcmd = "update " + tablename + " set class = 'f'" + " where " + prop + '=' + value;
            cmd = new MySqlCommand(Mysqlcmd, conn);
            try
            {
                if (cmd.ExecuteNonQuery() > 0)
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            ...
            String Sqlcmd = "create table " + tablename + " (number int primary key, name varchar(30) not null, age varchar(30) not null, sex varchar(30) not null, class varchar(30) not null)";
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            Sqlcmd = "insert into " + tablename + " values(" + key + ", 'a', 'b', 'c', 'd')";
