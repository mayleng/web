...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <span>请选择：</span>
    <asp:Button ID="Button1" runat="server" Height="35px" Text="Oracle" Width="85px" Onclick="btnOracle"/>
    &nbsp;
    ...
    &nbsp; 
    <asp:Button ID="Button7" runat="server" Height="35px" Text="Mongodb_legacy" Width="111px" Onclick="btnMongoDB2"/>
    &nbsp;
    <asp:Button ID="Button8" runat="server" Height="35px" OnClick="Button8_Click" Text="Redis" Width="76px" />
    &nbsp;
    <asp:Button ID="Button9" runat="server" Height="35px" OnClick="Button7_Click" Text="Entity Framework" />
    <br />
    <br />
</asp:Content>