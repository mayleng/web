<%@ Page Title="创建" Language="C#" AutoEventWireup="true" CodeBehind="createtable.aspx.cs" Inherits="WebApplication1.Oracletest_createtable" %>
...
<body>
    <form id="form1" runat="server">
        <div>    
            <div>
                <span style="font-size:larger;">Oracle创建表测试：</span>
            </div>
            <div>
