<%@ Page Title="删除" Language="C#" AutoEventWireup="true" CodeBehind="deletedata.aspx.cs" Inherits="WebApplication1.deletedata" %>
...
<body>
    <form id="form1" runat="server">
        <div>    
            <div>
                <span style="font-size:larger;">Oracle删除表测试：</span>
            </div>
            <div>
