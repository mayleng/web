...
<body>
    ...
    <div>
        ...
        Redis 数据添加：<br />
        <br />
        键:<asp:TextBox ID="key0" runat="server" Width="107px" OnTextChanged="key0_TextChanged" Text="test"></asp:TextBox>
&nbsp; 值:<asp:TextBox ID="value0" runat="server" Width="105px" Text="1"></asp:TextBox>
&nbsp; 生存时间(分钟):<asp:TextBox ID="expiret" runat="server" Text="1"></asp:TextBox>
        <br />
        <br />
...
&nbsp;&nbsp;
        ...
        HashSet:<br />
        <br />
        Key:<asp:TextBox ID="TextBox1" runat="server" Text="test"></asp:TextBox>
&nbsp; Field:<asp:TextBox ID="TextBox2" runat="server" Text="testField"></asp:TextBox>
&nbsp; Value:<asp:TextBox ID="TextBox3" runat="server" Text="testValue1"></asp:TextBox>
        <br />
        <br />
